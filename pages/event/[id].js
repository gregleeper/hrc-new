            ...
            return (
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 font-sans ">
                    <div className="max-w-lg my-8">
                        ...
                        {event.HomeTeam.roster.items.length && event.AwayTeam.roster.items.length ? (
                            <div className="w-full py-10">
                                <div className="w-3/6 mx-auto leading-relaxed">
                                    <div>
                                        <p className="text-center text-lg font-semibold">{event.AwayTeam.name}</p>
                                        <ul>
                                ...
                                <div className="w-3/6 mx-auto mt-4 leading-relaxed">
                                    <div>
                                        <p className="text-center text-lg font-semibold">{event.HomeTeam.name}</p>
                                        <ul>
